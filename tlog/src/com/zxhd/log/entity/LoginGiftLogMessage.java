...
/**
  ...
  * 此类用工具生成，不可修改
  */
public class LoginGiftLogMessage implements ILogCodec{
	
	public LoginGiftLogMessage(){}
	
	public LoginGiftLogMessage(int serverId,int iUserId,String vAccount,int contentOfGiftId,String dActionTime){
	...
	public String getUpdateSql() {
		return "insert into loginGiftLog values(" + iEventId + "," + serverId+","+iUserId+","+"'" + vAccount+ "'"+","+contentOfGiftId+","+"'" + dActionTime+ "'" + ")";
	}

	//@Override
	public String getCreateTableSql() {
		return "create table loginGiftLog (iEventId bigint(20) comment '事件id', serverId int(11) comment'服务器Id',iUserId int(11) comment'用户id',vAccount varchar(45) comment'帐号',contentOfGiftId int(11) comment'礼包ID',dActionTime timestamp comment'发生时间',primary key(iUserId, serverId, iEventId))ENGINE=MyISAM DEFAULT CHARSET=utf8;" ;
	}
