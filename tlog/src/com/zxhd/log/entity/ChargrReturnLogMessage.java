...
/**
  ...
  * 此类用工具生成，不可修改
  */
public class ChargrReturnLogMessage implements ILogCodec{
	
	public ChargrReturnLogMessage(){}
	
	public ChargrReturnLogMessage(int serverId,int iUserId,String vAccount,int actionType,int awardId,String dActionTime){
	...
	public String getUpdateSql() {
		return "insert into chargrReturnLog values(" + iEventId + "," + serverId+","+iUserId+","+"'" + vAccount+ "'"+","+actionType+","+awardId+","+"'" + dActionTime+ "'" + ")";
	}

	//@Override
	public String getCreateTableSql() {
		return "create table chargrReturnLog (iEventId bigint(20) comment '事件id', serverId int(11) comment'服务器Id',iUserId int(11) comment'用户id',vAccount varchar(45) comment'帐号',actionType int(11) comment'1:充值 2：领取奖励',awardId int(11) comment'奖励钻石数量',dActionTime timestamp comment'发生时间',primary key(iUserId, serverId, iEventId))ENGINE=MyISAM DEFAULT CHARSET=utf8;" ;
	}

	//@Override
	public String getFileContent() {
		return LogFileUtil.convertObjects2String(serverId,iUserId,vAccount,actionType,awardId,dActionTime);
	}
