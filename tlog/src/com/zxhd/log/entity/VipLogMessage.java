...
/**
  ...
  * 此类用工具生成，不可修改
  */
public class VipLogMessage implements ILogCodec{
	
	public VipLogMessage(){}
	
	public VipLogMessage(int serverId,int iUserId,String vAccount,int vipLevel,String dActionTime){
	...
	public String getUpdateSql() {
		return "insert into vipLog values(" + iEventId + "," + serverId+","+iUserId+","+"'" + vAccount+ "'"+","+vipLevel+","+"'" + dActionTime+ "'" + ")";
	}

	//@Override
	public String getCreateTableSql() {
		return "create table vipLog (iEventId bigint(20) comment '事件id', serverId int(11) comment'服务器Id',iUserId int(11) comment'用户id',vAccount varchar(45) comment'帐号',vipLevel int(11) comment'vip等级',dActionTime timestamp comment'发生时间',primary key(iUserId, serverId, iEventId))ENGINE=MyISAM DEFAULT CHARSET=utf8;" ;
	}

	//@Override
	public String getFileContent() {
		return LogFileUtil.convertObjects2String(serverId,iUserId,vAccount,vipLevel,dActionTime);
	}
