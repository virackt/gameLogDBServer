...
/**
  ...
  * 此类用工具生成，不可修改
  */
public class PauseLogMessage implements ILogCodec{
	
	public PauseLogMessage(){}
	
	public PauseLogMessage(int serverId,String vUuid,String vQudaoTag,String vMachineBrand,String vMachineSystem,String dActionTime){
	...
	public String getUpdateSql() {
		return "insert into pauseLog values(" + iEventId + "," + serverId+","+"'" + vUuid+ "'"+","+"'" + vQudaoTag+ "'"+","+"'" + vMachineBrand+ "'"+","+"'" + vMachineSystem+ "'"+","+"'" + dActionTime+ "'" + ")";
	}

	//@Override
	public String getCreateTableSql() {
		return "create table pauseLog (iEventId bigint(20) comment '事件id', serverId int(11) comment'服务器Id',vUuid varchar(100) comment'设备唯一id',vQudaoTag varchar(100) comment'渠道标记',vMachineBrand varchar(100) comment'设备品牌',vMachineSystem varchar(100) comment'设备系统版本号',dActionTime timestamp comment'发生时间',primary key(serverId, iEventId))ENGINE=MyISAM DEFAULT CHARSET=utf8;" ;
	}
